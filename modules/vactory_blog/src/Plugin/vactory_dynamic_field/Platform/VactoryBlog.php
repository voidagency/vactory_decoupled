...
namespace Drupal\vactory_blog\Plugin\vactory_dynamic_field\Platform;
...
class VactoryBlog extends VactoryDynamicFieldPluginBase {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, $widgetsPath) {
    parent::__construct($configuration, $plugin_id, $plugin_definition, drupal_get_path('module', 'vactory_blog') . '/widgets');
  }
