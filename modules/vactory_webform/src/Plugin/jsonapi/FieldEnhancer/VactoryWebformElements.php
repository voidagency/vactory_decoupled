...
namespace Drupal\vactory_webform\Plugin\jsonapi\FieldEnhancer;

use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\jsonapi_extras\Plugin\ResourceFieldEnhancerBase;
use Drupal\vactory_webform\Webform;
...
class VactoryWebformElements extends ResourceFieldEnhancerBase implements ContainerFactoryPluginInterface
{
  ...
  /**
   * @var \Drupal\vactory_webform\Webform
   */
