...
class VactotyIconSettingsForm extends ConfigFormBase
{
    ...
    {
        $currentMillis = \Drupal::time()->getCurrentTime();
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        try {
            ...
            //============ Delete zip itself ( doesnt work ) ============
            try {
                return \Drupal::service('file_system')->delete($absolute_path);
            }
            ...
            file_delete($fid);
            file_unmanaged_delete($absolute_path);
...
//            watchdog_exception('custom_module_name', $exception);
            ...
            drupal_set_message('ma tdezippach');
        }
    }
